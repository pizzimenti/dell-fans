...
run_case() {
    ...
    actual="$(desired_state "$current" "$cpu" "$gpu" "$gpu_w" "$wifi" "$on_ac")"
...
run_case "battery_hot_gpu_to_state2" 0 50 73 5 60 0 2
run_case "ac_gpu_power_to_state2" 0 50 50 24 60 1 2
run_case "state1_holds_without_cooldown" 1 56 55 5 60 0 1
run_case "state1_drops_when_cool" 1 50 50 5 60 0 0
run_case "state2_drops_to_state1_when_cooled" 2 60 61 5 60 1 1
